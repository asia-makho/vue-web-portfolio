...
export const translations: Record<'uk' | 'en', TranslationSchema> = {
  uk: {
    ...
    eduTitle: "Освіта",
    uniName: "НТУУ КПІ ім. Ігоря Сікорського, ФБМІ",
    uniSpecialty: "Спеціальність: Комп'ютерні науки",
    uniPeriod: "Період: 2024 - 2028",
    projectsTitle: "Мої проєкти",
    projTech: "Інструменти",
    proj1Title: "Python Turtle Heart",
    proj1Desc: "Після того, як я навчилася будувати графіки для студентської ради, я вирішила створити власний креативний міні-проект.",
    proj2Title: "Telegram Horoscope Bot",
    proj2Desc: "Програма генерує гороскопи на основі дат народження.",
    expTitle: "Волонтерський досвід",
    expRole: "Технічний відділ Студентської ради ФБМІ",
    expPeriod: "Період: 2024 - теперішній час",
    expDesc1: "Обробка опитувань щодо викладачів та побудова статистичних діаграм за допомогою Python (matplotlib).",
    expDesc2: "Робота в команді над спільними завданнями.",
